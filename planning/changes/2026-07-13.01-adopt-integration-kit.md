---
summary: Compose modern_di.integrations (Marker, from_di, parse_markers, resolve_markers) instead of hand-rolling the FromDI marker and its parse/resolve pair; no public-API change.
---
